...
class Auto
{
    ...
    public function AutoALinea()
    {
        if ($this->_fecha != null) {

            return $this->_color . "," . $this->_marca . "," . $this->_precio . "," . $this->_fecha->format("Y-m-d") . PHP_EOL;
         
        }
        return $this->_color . "," . $this->_marca . "," . $this->_precio . ","  . PHP_EOL;
    }
